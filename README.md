...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/VARSHAN69/css-box-shadow-generator.git
   cd css-box-shadow-generator
   ```
...
[![Repo](https://img.shields.io/badge/css-box-shadow-generator-Repo-00CC66?style=for-the-badge&logo=github&logoColor=black)](https://github.com/VarshuAi/css-box-shadow-generator)
